...
use Dmishh\Bundle\SettingsBundle\Manager\CachedSettingsManager;
...
class CachedSettingsManagerTest extends \PHPUnit_Framework_TestCase
{
    public function testGet()
    {
        ...
        $settingManager = \Mockery::mock('Dmishh\Bundle\SettingsBundle\Manager\SettingsManager');
    ...
    public function testGetHit()
    {
        ...
        $settingsManager = \Mockery::mock('Dmishh\Bundle\SettingsBundle\Manager\SettingsManager');
